var KhaltiCheckout = (function () {
        ...
        i =
            ((function (t, e) {
                ...
                var i =
                    ...
                    o = (e.SkipValidation = function (t) {
                        (this.name = "SkipValidation"), (this.message = t);
                    }),
                    r = (e.validateSingle = function (t, e, n, i, r) {
                        var a = [];
                ...
                (e.validate = function (t, e, n) {
                    ...
                    (e.required = function (t, e) {
                        ...
                        return function (i) {
                            ...
                            if (!t && n(i)) throw new o();
                        };
                    }),
                    (e.isNumber = function (t) {
                        return function (e) {
                            if ("number" != typeof e || isNaN(e))
                                return t || "'{value}' is not a valid number.";
                        };
                    }),
                    (e.isString = function (t) {
                        return function (e) {
                            if ("string" != typeof e)
                                return t || "'{value}' is not a valid string.";
                        };
                    }),
                    (e.isFunction = function (t) {
                        return function (e) {
                            if ("function" != typeof e)
                                return t || "Expected a function.";
                        };
                    }),
                    (e.isObject = function (t) {
                        return function (e) {
                            if (e !== Object(e))
                                return t || "Expected an object.";
                        };
                    }),
                    ...
                    (e.length = function (t, e) {
                        return function (n) {
                            if ((n + "").length !== t)
                                return (
                                    e || "It must be " + t + " characters long."
                                );
                        };
                    }),
                    (e.isEmail = function (t) {
                        return function (e) {
                            if (
                                ...
                                return t || "Invalid email id.";
                        };
                    }),
                    (e.equalsTo = function (t, e) {
                        return function (n, i) {
                            if (n !== i[t])
                                return (
                                    e || "'{key}' and '" + t + "' do not match."
                                );
                        };
                    }),
                    (e.minLength = function (t, e) {
                        return function (n) {
                            if ((n + "").length < t)
                                return (
                                    e ||
                    ...
                    (e.isBoolean = function (t) {
                        return function (e) {
                            if (!0 !== e && !1 !== e)
                                return t || "Invalid boolean value.";
                        };
                    }),
                    (e.within = function (t, e) {
                        return function (n) {
                            n instanceof Array || (n = [n]);
                            for (var i = [], o = 0; o < n.length; o++)
                                -1 === t.indexOf(n[o]) && i.push(n[o]);
                            if (i.length > 0)
                                return (
                                    e ||
                                    "[" +
                                        i +
                                        "] do not fall under the allowed list."
                                );
                        };
                    }),
                    (e.excludes = function (t, e) {
                        return function (n) {
                            n instanceof Array || (n = [n]);
                            for (var i = [], o = 0; o < n.length; o++)
                                -1 !== t.indexOf(n[o]) && i.push(n[o]);
                            if (i.length > 0)
                                return (
                                    e ||
                                    "[" + i + "] fall under restricted values."
                                );
                        };
                    }),
                    (e.pattern = function (t, e) {
                        return function (n) {
                            if (!t.test(n))
                                return (
                                    e ||
                                    "'{value}' does not match with the pattern."
                                );
                        };
                    });
            })((t = { exports: {} }), t.exports),
    ...
    (e = i) &&
        ...
        e.default;
    i.SkipValidation, i.validateSingle;
    var o = i.validate,
        r = i.required,
            ...
            u(t, [
                {
                    ...
                    value: function () {
                        ...
                        window.addEventListener(
                            ...
                            function (e) {
                                if (e.data.realm)
                                    if ("widgetInit" === e.data.realm)
                                        t.widgetInit(e.data.payload);
                                    else if (
                                        "widgetLoad" !== e.data.realm ||
                                        t.widgetLoaded
                                    ) {
                                        if (
                                            !e.data.payload ||
                                            e.data.payload.widget_id !==
                                                t._widgetId
                                        )
                                            return;
                ...
                },
                {
                    key: "msgWidget",
                    value: function (t, e) {
                        ((e = c(e)).widgetId = this._widgetId),
                            (e.source = "checkout_v2.1"),
                ...
                },
                {
                    key: "widgetInit",
                    value: function (t) {
                        var e = c(this._config);
                        delete e.eventHandler, this.msgWidget("paymentInfo", e);
                    },
                },
                {
                    key: "diplayLoader",
                ...
                },
                {
                    key: "validateConfig",
                    value: function () {
                        var t = o(this._config, y);
                        if (t) throw new Error(JSON.stringify(t));
                        var e = o(this._config.eventHandler, f);
                        if (e)
                            throw new Error(
                                JSON.stringify({ eventHandler: e })
                            );
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        return (
                            e.setAttribute("id", "loader" + this._widgetId),
                            (e.style.width = "100%"),
                            (e.style.height = "100%"),
                            ...
                            (e.innerHTML =
                                '<img style="position:relative;left:50%;top:50%;transform:translate(-50%, -50%);z-index: 99999;" src=https://khalti.s3.ap-south-1.amazonaws.com/KPG/dist/2020.12.17.0.0.0/icons/infinity-loader.svg></img>'),
                            window.document.body.contains(e) ||
