                                    ...
                                    <div class="cd-dropdown-wrapper">
                                        <a class="house_toggle" href="#0">
                                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                y="0px" width="511.63px" height="511.631px"
                                            ...
                                            @else
                                                <li>
                                                    ...
                                                    <a href="{{ route('user.account') }}"
                                                        class="menu-button single_menu">Account</a>
                                                </li>
                                            @endguest
                                        </ul>
                                        <!-- .cd-dropdown-content -->
                                ...
                                <div class="x_css_tabs_wrapper float_left">
                                    <div class="x_css_tabs_main_wrapper float_left">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#home"> User
                                                    ReView
                                                </a>
                                            </li>
                                        ...
                                        <div id="home" class="tab-pane active">
                                            ...
                                            <div class="x_css_skills_form_wrapper">
                                                ...
                                                <div class="row only_left">
                                                    ...
                                                    @guest
                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <p>You Need to <a style="color: #4f5dec"
                                                                    href="{{ route('login') }}">login</a> to leave a
                                                                review</p>
                                                        </div>
                                                    @else
                                                        <form method="POST"
                                                            action="{{ route('bike.review', ['bike' => $bike->id]) }}">
                                                            @csrf
                                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="contect_btn x_css_form_btn">
                                                                    <ul>
                                                                        <li><input id="book" type="submit"
                                                                                name="submit" value="Leave a Review"
                                        ...
                                        <div class="blog_comment3_wrapper">
                                            ...
                                            @forelse ($reviews as $review)
                                                <div class="blog_comment1_cont">
                                                    <h3>{{ $review->user->name }} <i class="fa fa-circle"></i>
                                                ...
                                                <div class="form-sec-header">
                                                    ...
                                                    <label>Additional Info
                                                        <input type="text" name="info"
                                                            placeholder="Very Urgent" class="form-control">
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            @else
                                                <div class="col-md-12">
                                                    <div class="x_slider_checout_right x_slider_checout_right_carbooking">
                                                        <ul>
                                                            <li>
                                                                <input id="book" type="submit" name="submit"
                                                                    value="Book Now" class="btn btn-lg btn-block"
                                                                    style="background-color: #4f5dec; color:#ffff" />
                                                            </li>
                                                        </ul>
                                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="x_footer_bottom_box_wrapper_third float_left">
                        ...
                        <div class="x_footer_bottom_icon_section x_footer_bottom_icon_section2 float_left">
                            <div class="x_footer_bottom_icon x_footer_bottom_icon2"> <i class="fa fa-users"></i>
                            </div>
                            <div class="x_footer_bottom_icon_cont">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="x_footer_bottom_box_wrapper_third float_left">
                        ...
                        @guest
                            ...
                            <div class="x_footer_bottom_icon_section x_footer_bottom_icon_section2 float_left">
                                <div class="x_footer_bottom_icon x_footer_bottom_icon2"> <i class="fa fa-plus-circle"></i>
                                </div>
                                <div class="x_footer_bottom_icon_cont">
                                    <h4>Register</h4>
