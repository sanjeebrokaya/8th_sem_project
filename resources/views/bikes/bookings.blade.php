                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="x_car_offer_main_boxes_wrapper float_left">
                                                ...
                                                <div class="x_car_offer_img float_left">
                                                    <img src="/storage/bikes/{{ $booking->bike->thumbnail }}"
                                                        alt="img">
                                                </div>
                                                ...
                                                <div class="x_car_offer_bottom_btn float_left">
                                                    <ul>
                                                        <li><a
                                                                href="{{ route('bike.showRent', ['booking' => $booking->id]) }}">Details</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    @forelse($appointments as $appointment)
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="x_car_offer_main_boxes_wrapper float_left">
                                                ...
                                                <div class="x_car_offer_img float_left">
                                                    <img src="/storage/mechanics/{{ $appointment->mechanic->thumbnail }}"
                                                        alt="img">
                                                </div>
                                                <div class="x_car_offer_price float_left">
                                                    <div class="x_car_offer_price_inner">
                                                ...
                                                <div class="x_car_offer_bottom_btn float_left">
                                                    <ul>
                                                        <li><a
                                                                href="{{ route('mech.show', ['appointment' => $appointment->id]) }}">Details</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
